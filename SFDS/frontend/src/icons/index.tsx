...
const PieChartIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className} width="24" height="24" viewBox="0 0 24 24" fill="none">
    <path d="M21.21 15.89A10 10 0 118 2.83" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
    <path d="M22 12A10 10 0 0012 2v10z" stroke="currentColor" strokeWidth="1.5" />
  </svg>
);
...
const BoxCubeIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className} width="24" height="24" viewBox="0 0 24 24" fill="none">
    ...
    <path d="M3.27 6.96L12 12l8.73-5.04M12 22.08V12" stroke="currentColor" strokeWidth="1.5" />
  </svg>
);

const PlugInIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className} width="24" height="24" viewBox="0 0 24 24" fill="none">
    <path d="M12 22v-5M7 3h10l2 4v5a5 5 0 01-5 5h-2M5 7l-2 5a5 5 0 005 5h8a5 5 0 005-5l-2-5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
  </svg>
);
